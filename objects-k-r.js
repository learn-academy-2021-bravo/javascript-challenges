...
// Update the person object with a method that logs "Arthur Dent is from planet Earth".
 ...
 //person.description = () => {console.log(`${person.firstName} ${person.lastName} is from planet earth`)};
...
// lunch.sandwhich = () => {console.log(`The ingredients for a ${lunch.name} ${lunch.type} are ${lunch.ingredients}.`)} 
