...
// describe("needCaffeine", ()=> {
//     test ("returns Drink coffee",()=>{
//         expect(needCaffeine("not tired")).toEqual("Keep working")
//         expect(needCaffeine("tired")).toEqual("Drink coffee")
//     })
// })
// const needCaffeine = (mood) =>{
//     if (mood === "tired"){
//         return "Drink coffee"
//     }
//     else{
