...
// console.log("Write the code that will log the outcome of 34 added to 71.");
// console.log(34 + 71);
// console.log(
//   "Write the code that will log the outcome of 67 subtracted from 123."
// );
// console.log(123 - 67);
// console.log("Write the code that will log the outcome of 56 multiplied by 23.");
// console.log(56 * 23);
// console.log("Write the code that will log the outcome of 45 divided by 5.");
// console.log(45 / 5);
// console.log("Write the code that will log the outcome of 5 to the power of 7");
// console.log(5 ** 7);
